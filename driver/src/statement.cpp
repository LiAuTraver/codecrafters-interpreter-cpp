...
auto Print::to_string(const auxilia::FormatPolicy &format_policy) const
    -> string_type {
...
auto Expression::to_string(const auxilia::FormatPolicy &format_policy) const
    -> string_type {
...
auto Block::to_string(const auxilia::FormatPolicy &format_policy) const
    -> string_type {
  if (statements.empty())
    return "{<empty block>}";
...
auto While::to_string(const auxilia::FormatPolicy &format_policy) const
    -> string_type {
...
auto If::to_string(const auxilia::FormatPolicy &format_policy) const
    -> string_type {
...
auto Function::to_string(const auxilia::FormatPolicy &format_policy) const
    -> string_type {
...
auto Return::to_string(const auxilia::FormatPolicy &format_policy) const
    -> string_type {
...
auto For::to_string(const auxilia::FormatPolicy &format_policy) const
    -> string_type {
  auto result = "for ("s;
  if (this->initializer) {
