...
int main(int, char *[]) {
  ...
  // later inspection. When needed, call dump_backtrace() to see what happened:
...
void udp_example() {
  ...
  // use `nc -u -l 11091` in linux terminal to receive the log messages
...
#if not defined(SPDLOG_NO_TLS) && __has_include("spdlog/mdc.h")
